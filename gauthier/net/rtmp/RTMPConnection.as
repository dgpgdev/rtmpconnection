package gauthier.net.rtmp
{
	...
	import gauthier.net.rtmp.config.*;
	...
	*/
    ...
    //--------------------------------------------------------------------------
		...
		private function createConnection():void{
			if(devKey){
				__protocol = RTMPProtocol.RTMPFP;
			}
		 ...
		 *			}
		 *			
		 *			public function set flashMediaServerConnection(FMSC:RTMPConnection):void
		 *			{
		 ...
		 *			}
		 *			
		 * 			public function get flashMediaServerConnection():RTMPConnection
		 *			{
